				...
				<Row>
					<Col lg={8} md={6} sm={12}>
						<h3 className="ml-5 mr-5">
							Stay in {data.sreemangalDummyData.title}
						</h3>
						<Row>
							...
							<Col lg={6} md={6} sm={6} xs={6}>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel1.title}
								</p>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel1.guests}
								</p>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel1.ratings}
								</p>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel1.price}
								</p>
							</Col>
						</Row>
						...
						<Row>
							...
							<Col lg={6} md={6} sm={6} xs={6}>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel2.title}
								</p>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel2.guests}
								</p>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel1.ratings}
						...
						<Row>
							...
							<Col lg={6} md={6} sm={6} xs={6}>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel3.title}
								</p>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel3.guests}
								</p>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel3.ratings}
								</p>
								<p className="lead" style={{ fontSize: "14px" }}>
									{" "}
									{data.sreemangalDummyData.hotel3.price}
								</p>
							</Col>
						</Row>
					</Col>
